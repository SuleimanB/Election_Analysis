...
#Initialized empty string that will hold county name for largest turnout 
winning_candidate = ""
winning_county = ""
winning_county_count = 0
#Initialize a variable like the winning_count variable that will hold the number of votes of the county with the largest turnout
value = 0 
winning_count = 0
